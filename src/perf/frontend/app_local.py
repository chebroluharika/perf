...
def generate_summary(workload, performance_tunings):
    ...
    summary_prompt = """
    You are a performance tuning assistant. Given the following performance tuning data for WORKLOAD, generate a summary that emphasizes configuration settings that need attention and their corresponding recommendations. For each tuning setting, you should output a brief summary.
...
def recommend_perf_tunables_object_workloads(_):
